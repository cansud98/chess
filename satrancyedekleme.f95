...
if(a(i2,j2).eq.0.and.ifark.gt.0.and.jfark.eq.0) then
a(i1,j1)=0
a(i2,j2)=2
endif
...
if(a(i2,j2).eq.0.and.abs(ifark).eq.2.and.abs(jfark).eq.1)then
a(i1,j1)=0
a(i2,j2)=3
endif


if(a(i2,j2).eq.0.and.abs(ifark).eq.1.and.abs(jfark).eq.2)then
a(i1,j1)=0
a(i2,j2)=3
endif
...
if(a(i2,j2).eq.0.and.ifark.eq.2.and.abs(jfark).eq.1)then
a(i1,j1)=0
a(i2,j2)=-3
endif


if(a(i2,j2).eq.0.and.ifark.eq.1.and.abs(jfark).eq.2)then
a(i1,j1)=0
a(i2,j2)=-3
endif
